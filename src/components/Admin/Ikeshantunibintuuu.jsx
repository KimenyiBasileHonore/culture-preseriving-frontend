...
function Ikenshkumwami() {
  ...
  const fetchUmwamiList = async () => {
    try {
      const response = await axios.get("http://localhost:4050/api/ahantu/ahantu");
  ...
  const createUmwami = async () => {
    try {
      await axios.post("http://localhost:4050/api/ahantu/ahantu", {
        title: newTitle,
        summary: newSummary,
        details: newDetails,
      });
  ...
  const updateUmwami = async (id, updatedData) => {
    try {
      await axios.put(`http://localhost:4050/api/ahantu/ahantu/${id}`, updatedData);
  ...
  const deleteUmwami = (id) => {
    ...
    axios.delete(`http://localhost:4050/api/ahantu/ahantu/${id}`)
      .then(() => {
