...
export default function IbyivugoCRUD() {
    ...
    const fetchImiganimiremireList = async () => {
        try {
            const response = await axios.get('http://localhost:4050/api/inka/inka');
    ...
    const handleCreate = async (newImiganimiremire) => {
        try {
            await axios.post('http://localhost:4050/api/inka/inka', newImiganimiremire);
            fetchImiganimiremireList();
        } catch (error) {
    ...
    const handleUpdate = async (updatedImiganimiremire) => {
        try {
            await axios.put(`http://localhost:4050/api/inka/inka/${updatedImiganimiremire._id}`, updatedImiganimiremire);
            fetchImiganimiremireList();
    ...
    const handleDelete = async (imiganimiremireId) => {
        try {
            await axios.delete(`http://localhost:4050/api/inka/inka/${imiganimiremireId}`, { data: imiganimiremireId });
            fetchImiganimiremireList();
        } catch (error) {
    ...
    return (
        <div className="p-4">
            <h1 className="text-3xl font-bold mb-6">Amazina y 'inka </h1>
