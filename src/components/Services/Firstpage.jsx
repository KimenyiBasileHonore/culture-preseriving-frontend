                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p class="leading-relaxed mb-3">Nkuko amateka y’ubuvanganzo nyarwanda abigaragaza ,umugani n’ipfundo ry’amagambo atonze neza,Gacamigani yakagiriyemo ihame ridutoza gukora iki cyangwa se kudakora kiriya.</p>
                                <Link 
                        ...
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p class="leading-relaxed mb-3">Umuntu aca amarenga ashaka kubwira uwo baziranye, icyo adashaka kubwira abamwumva bose. </p>
                        ...
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p class="leading-relaxed mb-3">Ikeshamvugo ni ubuhanga bukoreshwa mu kuvuga no guhanga mu kinyarwanda. Iyo akaba ari imvugo inoze, yuje ikinyabupfura, ifite inganzo kandi ivugitse ku buryo bunoze.</p>
                                <Link class="text-indigo-500 inline-flex items-center">Learn More
                    ...
                    <div class="flex flex-wrap -m-4">
                        ...
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p class="leading-relaxed mb-3">U Rwanda ntirufite amateka maremare ajyanye n'Ubuvanganzo bwanditse, ariko hari ubuvangazo
