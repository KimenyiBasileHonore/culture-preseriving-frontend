                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p class="leading-relaxed mb-3">Umugani n’ipfundo ry’amagambo atonze neza,Gacamigani yakagiriyemo ihame ridutoza gukora iki cyangwa se kudakora kiriya.</p>
                                {/* <Link 
                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p class="leading-relaxed mb-3">Ibisakuzo ni umukino wo mu magambo, ibibazo n’ibisubizo bihimbaza abakuru n’abato kandi birimo ubuhanga. </p>
                                {/* <Link class="text-indigo-500 inline-flex items-center">Learn More
